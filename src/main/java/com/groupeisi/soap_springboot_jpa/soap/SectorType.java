...
/**
 * <p>Classe Java pour sectorType complex type.
 * 
 ...
 *         &lt;element name="classes" type="{http://groupeisi.com/soap}classeType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SectorType {
    ...
    protected List<ClasseType> classes;
     ...
     * 
     */
    public List<ClasseType> getClasses() {
        if (classes == null) {
            classes = new ArrayList<ClasseType>();
        }
        return this.classes;
    }
